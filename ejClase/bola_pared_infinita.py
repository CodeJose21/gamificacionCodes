'''Quitamos la gravedad y el suelo para que no haya ninguna otra interacción

TAL Y COMO ESTÁ, se ve que por muchos rebotes que haya el momento lineal
se conserva. Sea elástico o no.

SI AUMENTAMOS MUCHO LA MASA DE LA PARED. Se sigue conservando pero
llega un momento en que en la pared no se aprecia movimiento
...
def run_simulation():
	...
	body_p.position = (700, height - 300)
	...
	body_b.position = (100, 150)  #300 justo en el centro #200 hay doble rebote con 1kg
